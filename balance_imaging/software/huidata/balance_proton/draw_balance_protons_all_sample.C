...
//	color->SetRGB(0.0,0.4,0.0);
	...
	TPaveLabel *p0 = new TPaveLabel(xl-0.5,yl,xh,yh,"protons 0-5%");
	p0->SetBorderSize(0);
	p0->SetFillColor(0);
	...
	TLine *line0 = new TLine(0,0,1.6,0);
	TLine *line1 = new TLine(0,0,1.6,0);
	TLine *line2 = new TLine(0,0,1.6,0);
	TLine *line3 = new TLine(0,0,1.6,0);
	TLine *line4 = new TLine(0,0,1.6,0);
	TLine *line5 = new TLine(0,0,1.6,0);
	TLine *line6 = new TLine(0,0,1.6,0);
	TLine *line7 = new TLine(0,0,1.6,0);
	TLine *line8 = new TLine(0,0,1.6,0);
	...
	pad0->cd();
	gr0->Draw("AP");
	gr0->GetXaxis()->SetLimits(0.0,1.6);
	...
	gr1->Draw("AP");
	gr1->Draw("AP");
	gr1->GetXaxis()->SetLimits(0.0,1.6);
	...
	pad2->cd();
	gr2->Draw("AP");
	gr2->GetXaxis()->SetLimits(0.0,1.6);
	...
	pad3->cd();
	gr3->Draw("AP");
	gr3->GetXaxis()->SetLimits(0.0,1.6);
	...
	pad4->cd();
	gr4->Draw("AP");
	gr4->GetXaxis()->SetLimits(0.0,1.6);
	...
	pad5->cd();
	gr5->Draw("AP");
	gr5->GetXaxis()->SetLimits(0.0,1.6);
	...
	pad6->cd();
	gr6->Draw("AP");
	gr6->GetXaxis()->SetLimits(0.0,1.6);
	...
	pad7->cd();
	gr7->Draw("AP");
	gr7->GetXaxis()->SetLimits(0.0,1.6);
	...
	pad8->cd();
	gr8->Draw("AP");
	gr8->GetXaxis()->SetLimits(0.0,1.6);
	...
	c1->Print("balance_protons_all_sample.eps");
