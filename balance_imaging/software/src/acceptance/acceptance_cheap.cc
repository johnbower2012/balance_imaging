...
CAcceptance_CHEAP::CAcceptance_CHEAP() : CAcceptance(){
	ETAMIN=-6;
	ETAMAX=6;
	ptmin=0;
	ptmax=20000000.0;
...
void CAcceptance_CHEAP::CalcAcceptance(bool &accept,double &efficiency,CPart *part,int centrality,double *dca){
