...
int main (int argc, char *argv[]){
  ...
  fitter.cerror3D=new C3DArray(filename);
	...
	CWaveFunction_generic *wf=new CWaveFunction_generic("parameters/kparameters_bowlersinyukov.dat",1.0,139.58,139.58,0.5);
	...
	*/
	...
	fitter.AddPar("lambda",0.3,0.05,0.1,1.4);
	fitter.AddPar("Rx",10,0.5,2.0,30.0);
	fitter.AddPar("Ry",8,0.5,2.0,20.0);
	fitter.AddPar("Rz",13,0.5,2.0,20.0);
	fitter.AddPar("Xoff",0.0,0.0,0.0,15.0);
	fitter.FixPar("Xoff");
	fitter.SetCalcFlag(10); // for pure boson wf
