...
void CDistCosh::FunctionSet(int grid, double x, int samples, int ab, int nmax, Eigen::MatrixXd G, Eigen::MatrixXd &Functions){
  Functions = Eigen::MatrixXd::Zero(grid+1,samples*ab+1);
  Eigen::VectorXd 
    width(ab);
  Eigen::MatrixXd 
    g(ab,nmax+1),
