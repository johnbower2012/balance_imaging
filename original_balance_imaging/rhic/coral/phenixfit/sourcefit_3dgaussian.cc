...
int main (int argc, char *argv[]){
  ...
  fitter.cerror3D=new C3DArray(filename);
	...
	//CWaveFunction_generic *wf=new CWaveFunction_generic("parameters/kparameters.dat",0,mass,mass,1.0);
	...
	fitter.AddPar("Rx",3.0,0.5,2.0,30.0);
	fitter.AddPar("Ry",5.0,0.5,2.0,20.0);
	fitter.AddPar("Rz",7.0,0.5,2.0,20.0);
